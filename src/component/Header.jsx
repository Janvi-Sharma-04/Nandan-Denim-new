...
const Header = () => {
    ...
    ${scrolled ? "bg-[#193267]" : "lg:bg-transparent bg-[#193267]"}`}
        >
            <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                ...
                <nav className="hidden lg:flex space-x-10 text-lg font-medium   font-signika" >
                    {navItems.map((item, index) => (
                        ...
                        >
                            <Link to={item.path} className="flex items-center  gap-1 text-white  hover:text-yellow-400 ">
