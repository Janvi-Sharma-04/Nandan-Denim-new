            ...
            <div>
                ...
                <div className="relative bg-[#193267] h-60 mt-14">
                    <h1 className="absolute max-w-7xl mx-auto px-32 p-20 text-white text-3xl sm:text-5xl md:text-7xl 
                     font-montserrat font-bold text-left">Women Tag</h1>
                </div>
                ...
                {/* women leadership */}
                <div className="mt-6 max-w-7xl mx-auto px-4 mb-10">
                    <h3 className="text-red-500 text-lg">
                        May 2, 2018 <span className="text-gray-400 font-montserrat"> / In Women Leadership / By</span> admin
                    </h3>
                    <h2 className="font-bold text-2xl sm:text-3xl md:text-4xl mt-2 hover:text-rose-500 transition font-montserrat">
                    ...
                    <p className="mt-5 text-gray-600 text-sm text-justify font-signika">
                        ...
                        Myth #1: Leaders are born (male). With the marginal numbers of women in executive levels of leadership,...
                    </p>
                    <Link
